...
#SBATCH --gres=gpu:8
#SBATCH --job-name=Kiwano_resnet200
...
#SBATCH --output=/lustre/fswork/projects/rech/mke/username/kiwano/recipes/resnet/logs/train_resnet200_%j.out   # Fichier de sortie
#SBATCH --error=/lustre/fswork/projects/rech/mke/username/kiwano/recipes/resnet/logs/train_resnet200_%j.err    # Fichier d'erreur
...
export EXP_DIR="$WORK_DIR/exp/resnet200"
...
#pr reprendre :
srun python3 utils/train_resnet.py --checkpoint $EXP_DIR/model28.ckpt --musan $MUSAN_DIR --rirs_noises $RIRS_NOISES_DIR $DATA_DIR $EXP_DIR
