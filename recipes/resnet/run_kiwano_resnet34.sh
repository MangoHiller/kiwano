...
#SBATCH --gres=gpu:4
#SBATCH --job-name=Kiwano_resnet50_reprise
...
#SBATCH --output=/lustre/fswork/projects/rech/mke/username/kiwano/recipes/resnet/logs/train_resnet50_%j.out   # Fichier de sortie
#SBATCH --error=/lustre/fswork/projects/rech/mke/username/kiwano/recipes/resnet/logs/train_resnet50_%j.err    # Fichier d'erreur
...
export EXP_DIR="$WORK_DIR/exp/resnet50"
...
#pr reprendre :
srun python3 utils/train_resnet.py --checkpoint $EXP_DIR/model75.ckpt --musan $MUSAN_DIR --rirs_noises $RIRS_NOISES_DIR $DATA_DIR $EXP_DIR
